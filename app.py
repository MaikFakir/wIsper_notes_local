...
if __name__ == "__main__":
    ...
    if not HF_TOKEN:
        ...
        print("La diarización de hablantes (identificar quién habla) no funcionará.")
        print("Para solucionarlo, configura la variable de entorno 'HF_TOKEN' con tu token de Hugging Face.")
        print("\nRecuerda aceptar los términos de uso de los siguientes modelos en Hugging Face:")
